...
@section('content')
    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 atractivos__form__boxFormInfoGeneral">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="row">
                <div class="col-lg-6 col-md-3">
                    <h5><strong><i class="fa fa-check-circle"></i> RUC Empresa :</strong></h5>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-3">
                    <h5><strong><i class="fa fa-check-circle"></i> Empresa :</strong></h5>
                </div>
                <div class="col-lg-6 col-md-9">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-3">
                    <h5><strong><i class="fa fa-check-circle"></i> Cargo: </strong></h5>
                </div>
                <div class="col-lg-6 col-md-9">
                    <h5>{{$oferta->cargo}}</h5>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-3">
                    <h5><strong><i class="fa fa-check-circle"></i> Area laboral: </strong></h5>
                </div>
                <div class="col-lg-6 col-md-9">
                    <h5>{{$oferta->area}}</h5>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-3">
                    <h5><strong><i class="fa fa-check-circle"></i> Disponibilidad: </strong></h5>
                </div>
                <div class="col-lg-6 col-md-9">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-3">
                    <h5><strong><i class="fa fa-check-circle"></i> Jornada laboral: </strong></h5>
                </div>
                <div class="col-lg-6 col-md-9">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6">
            <div class="row">
                <div class="col-lg-6 col-md-3">
                    <h5><strong><i class="fa fa-check-circle"></i> Salario Mensual: </strong></h5>
                </div>
                <div class="col-lg-6 col-md-9">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-3">
                    <h5><strong><i class="fa fa-check-circle"></i> Comentario acerca del salario: </strong></h5>
                </div>
                <div class="col-lg-6 col-md-9">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-3">
                    <h5><strong><i class="fa fa-check-circle"></i> Estudios mínimos requeridos: </strong></h5>
                </div>
                <div class="col-lg-6 col-md-9">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-3">
                    <h5><strong><i class="fa fa-check-circle"></i> Experiencia mínima requerida: </strong></h5>
                </div>
                <div class="col-lg-6 col-md-9">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-3">
                    <h5><strong><i class="fa fa-check-circle"></i> Características personales: </strong></h5>
                </div>
                <div class="col-lg-6 col-md-9">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-3">
                    <h5><strong><i class="fa fa-check-circle"></i> Disponibilidad de Movilidad: </strong></h5>
                </div>
                <div class="col-lg-6 col-md-9">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-3">
                    <h5><strong><i class="fa fa-check-circle"></i> N° de vacantes: </strong></h5>
                </div>
                <div class="col-lg-6 col-md-9">
